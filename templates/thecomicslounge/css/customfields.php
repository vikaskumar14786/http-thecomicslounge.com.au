...
<div class="fleft">					
<input onclick="change(this);  type="radio" checked="" value="<?php echo $dat;?>" name="Booking_day2316" id="Booking_day_field1" class="inputboxattrib fleft"> <label for="Booking_day_field1"><?php echo  date('D j M',strtotime($dat));?></label>
</div>
<?php } ?>
</div>
...
function change()
{
	...
	function change(el){
    $("#customProductData_1303_742").val(el.value) ;
	alert(el.value);
}
