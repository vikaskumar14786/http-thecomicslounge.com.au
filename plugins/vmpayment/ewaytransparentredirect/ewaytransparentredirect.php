<?php
/**
 *  Eway Transparent Redirect for virtuemart 2/3
...
class plgVMPaymentEwayTransparentRedirect extends vmPSPlugin {
    ...
    protected function getVmPluginCreateTableSQL() {
	    return $this->createTableSQL('Payment eWAY Transparent Redirect Table');
    }
	...
	if (!$this->selectedThisElement($method->payment_element)) {
        ...
        $shipping_address = $order['details']['ST'] ? $order['details']['ST'] : $order['details']['BT'];
  ...
  <tr><td>
  Card Name: </td>
  <td><input type="text" name="EWAY_CARDNAME" />
  </td></tr>
  <tr><td>
  Card Number:</td>
  <td> <input type="text" name="EWAY_CARDNUMBER" />
  </td></tr>
  <tr><td>
  Card Expiry Month: </td>
  <td>'.shopfunctions::listMonths('EWAY_CARDEXPIRYMONTH', 1).'
  </td></tr>
  <tr><td>
  Card Expiry Year: </td>
  <td>'.JHTML::_('select.genericlist', $options, 'EWAY_CARDEXPIRYYEAR', '', 'value', 'text', $result->Customer->CardExpiryYear).'
  </td></tr>
  <tr><td>
  Card CVN: </td>
  <td><input type="text" name="EWAY_CARDCVN" />
  </td></tr>
  <tr><td colspan="2">
