<?php
/**
 *  Eway Responsive Shared for virtuemart 2/3
...
class plgVMPaymentEwayResponsiveShared extends vmPSPlugin {
    ...
    protected function getVmPluginCreateTableSQL() {
	    return $this->createTableSQL('Payment eWAY Responsive Shared Table');
    }
	...
	if (!$this->selectedThisElement($method->payment_element)) {
		...
		$_SESSION['EwayAccessCode'] = $r2['AccessCode'];
	$html .= '
	Redirecting to payment page ....
<script>
	setTimeout(function(){
      self.location.href = "'. $sharedPaymentUrl .'";
	},2000);
</script>
';
