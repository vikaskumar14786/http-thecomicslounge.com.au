...
<?php else: ?>
	...
	?>
		<li class="<?php echo $item->mod_events_class; ?>">
			<?php if ($top_fields) echo modJCalProEventsHelper::renderFields($top_fields, $item); ?>
			...
			?></span>
			<?php endif; ?>
			<?php if ($bottom_fields) echo modJCalProEventsHelper::renderFields($bottom_fields, $item); ?>
		</li>
	<?php endforeach; ?>
	</ul>
<?php endif; ?>
