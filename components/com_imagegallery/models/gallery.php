...
/**
 * Methods supporting a list of Imagegallery records.
 *
 * @since  1.6
 */
class ImagegalleryModelGallery extends JModelList
{
	/**
	 * Constructor.
	 *
...
if (empty($list['direction']))
{
	...
	protected function getListQuery()
	{
		...
		if (!JFactory::getUser()->authorise('core.edit', 'com_imagegallery'))
		{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_IMAGEGALLERY_SEARCH_FILTER_DATE_FORMAT"), "warning");
