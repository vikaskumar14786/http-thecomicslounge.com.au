 ...
 * @since  1.6
 */
class VideoModelVideo extends JModelItem
{
	/**
	...
	{
		$app = JFactory::getApplication('com_video');

		// Load state from the request userState on edit or from the passed variable on default
		if (JFactory::getApplication()->input->get('layout') == 'edit')
		{
			$id = JFactory::getApplication()->getUserState('com_video.edit.video.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_video.edit.video.id', $id);
		}
	...
	{
		$this->addTablePath(JPATH_ADMINISTRATOR . '/components/com_video/tables');
