...
<?php endforeach; ?>
			<div class="jcal_categories">
				<input class="button" type="button" value="<?php echo JText::_('COM_JCALPRO_BUTTON_' . ($this->item->id ? 'EDIT' : 'ADD') . '_EVENT'); ?>" onclick="Joomla.submitbutton('event.save');" />
				<input class="button" type="button" value="<?php echo JText::_('COM_JCALPRO_BUTTON_BACK'); ?>" name="cancel_add_event" onclick="document.getElementById('event-task').value='event.cancel';Joomla.submitbutton('event.cancel');" />
