...
<table
	...
	border="0"
	width="100%">
<tr class="pinkHeadingBox">
    <th class="vm-cart-item-name shopHeadsize1" ><?php echo vmText::_ ('Product'); ?></th>
	<th class="vm-cart-item-name shopHeadsize1" ><?php echo vmText::_ ('COM_VIRTUEMART_CART_NAME') ?></th>
	<th class="vm-cart-item-sku shopHeadsize1" ><?php echo vmText::_ ('COM_VIRTUEMART_CART_SKU') ?></th>
	<th	class="vm-cart-item-basicprice shopHeadsize1" ><?php echo vmText::_ ('COM_VIRTUEMART_CART_PRICE') ?></th>
	<th	class="vm-cart-item-quantity shopHeadsize1" ><?php echo vmText::_ ('COM_VIRTUEMART_CART_QUANTITY') ?></th>
...
<tr valign="top" class="cartitems sectiontableentry<?php echo $i ?>">
...
<tr class="sectiontableentry1">
	<td colspan="4" align="right"><?php echo vmText::_ ('Total'); ?></td>
		...
		if (!VmConfig::get ('show_tax') or $c>1) {
			...
			foreach( $this->cart->cartData['VatTax'] as $vatTax ) {
				if(!empty($vatTax['result'])) {
					...
					echo '<td align="right"><span class="priceColor2">'.''.'</span></td>';
					echo '<td></td><td></td>';
					echo '</tr>';
				}
			}
