...
?>
<div class="cartheading"><h1><?php echo vmText::_ ('SHOPPING CART'); ?></h1></div>
<div id="cart-view" class="cart-view">
	...
	?><form method="post" id="checkoutForm" name="checkoutForm" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart' . $taskRoute, $this->useXHTML, $this->useSSL); ?>">
		...
		?> <div class="checkout-button-top button btn-shopping"> <?php
	...
	<div class="width50 floatleft right vm-continue-shopping">
			<button style="float:left" class="button btn-shopping">
