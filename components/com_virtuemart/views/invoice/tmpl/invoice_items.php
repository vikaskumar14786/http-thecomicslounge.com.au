...
<td   align="right" class="pricePad"><?php echo $rule->label ?> </td>
					<?php 
					      $orderid= $this->orderDetails['details']['BT']->order_number;
                          $orderpass = $this->orderDetails['details']['BT']->order_pass;

					?>
						<td align="right"><b>Download Tickets<b></td>
					
					<td align="right"><a href="<?php echo JURI::base();?>/index.php?option=com_virtuemart&view=downloads&downloadid=<?php echo $orderid;?>&Itemid=62&func=download&order_numbe=<?php echo $orderid;?>&task=download&order_pass=<?php echo $orderpass;?>&layout=details">Download</a></td>
					<td align="right"></td>
				</tr>
</table>
