...
if (JPluginHelper::importPlugin("jevents", $jevplugin->name))
{
	...
	if (is_callable(array($classname, "fieldNameArray")))
	{
		...
		$typeid= str_replace(array("com_jevpeople.people.", ".bloglist"), "", $this->item->name);
		$fieldNameArray = call_user_func(array($classname, "fieldNameArray"),'bloglist', $showAddress,$typeid);
