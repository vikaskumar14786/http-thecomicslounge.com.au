...
<div id="header">
<form action="index.php?option=com_virtuemart&view=orders&task=exportOrders" method="post" name="adminForm2" id="adminForm2">		
		<div id="filterbox">
			<table>
				<tr>
					<td align="left" width="100%">
					
						<button type="submit"   class="btn btn-medium">Export Orders</button>
					</td>
				</tr>
			</table>
		</div>
