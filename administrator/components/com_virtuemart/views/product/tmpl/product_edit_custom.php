...
jQuery("#"+enddate).blur(function() {
	...
	{  
        ...
        mydates.forEach(function(entry) {
			...
			var newfieldlabel = curr_date + "/" + curr_month + "/" + curr_year;
             
			 jQuery("#custom_dates").append('<tr><td>'+newfieldlabel+'</td><td><input type="text" name="data['+curr_date + "_" + curr_month + "_" + curr_year+<?php echo $this->product->virtuemart_product_id;?>+'][showonlyprice]" value=""/></td><td><input type="text" name="data['+curr_date + "_" + curr_month + "_" + curr_year+<?php echo $this->product->virtuemart_product_id;?>+'][showwithmealprice]" value=""/></td><td>'+'<input type="text" value="'+curr_date + "/" + curr_month + "/" + curr_year+'" name="data['+curr_date + "_" + curr_month + "_" + curr_year+<?php echo $this->product->virtuemart_product_id;?>+'][text]"/>'+'</td></tr>');      
			});    
...
if($virtuemart_category_id ==20):
?>
VIP Event Link<br/>
<a id="clipboard" target="_blank" href="<?php echo JURI::root();?>index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=<?php echo $this->product->virtuemart_product_id;?>&virtuemart_category_id=<?php echo $this->product->virtuemart_category_id;?>&Itemid=106"><?php echo JURI::root();?>index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=<?php echo $this->product->virtuemart_product_id?>&virtuemart_category_id=<?php echo $this->product->virtuemart_category_id?>&Itemid=106</a> 
		...
		<?php
			...
			<fieldset style="background-color:#F9F9F9;">
				...
				<table id="custom_fields" class="adminlist" cellspacing="0" cellpadding="2">
					...
					<tr>
					<td>Date</td><td>Show only Price(AUD)</td><td>Show with Meal Price(AUD)</td><td></td>
					</tr>
					</tbody>
