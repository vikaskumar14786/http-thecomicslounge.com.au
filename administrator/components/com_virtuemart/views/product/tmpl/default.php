...
?>
	...
	<tr>
		...
		<?php if (!$product_parent_id ) { ?>
                ...
                <?php } ?>
				<?php if($this->virtuemart_category_id!=20): ?>
...
<th width="15%"><?php echo vmText::_( 'COM_VIRTUEMART_CATEGORY'); ?></th>
		...
		<th width="10%"><?php if($this->virtuemart_category_id==20): ?>
	    VIP Event Link
		<?php endif;?>
         </th>
		...
		foreach ($this->productlist as $key => $product) {
			...
			<tr class="row<?php echo $k ; ?>">
				...
				<!-- Vendor name -->
                                <?php } ?>
				<td><?php
				 if($this->virtuemart_category_id!=20): 
				...
				<?php if($this->virtuemart_category_id==20): ?>
				<td width="10%">
				<a id="clipboard" target="_blank" href="<?php echo JURI::root();?>index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=<?php echo $product->virtuemart_product_id?>&virtuemart_category_id=<?php echo $this->virtuemart_category_id;?>&Itemid=106"><?php echo JURI::root();?>index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=<?php echo $product->virtuemart_product_id?>&virtuemart_category_id=<?php echo $this->virtuemart_category_id;?>&Itemid=106</a> 
				</td>
				<?php endif;?>
				<td><?php echo $product->manuList;?></td>
...
jQuery("#clipboard").click(function(){
  var holdtext = jQuery("#clipboard").attr('href');
