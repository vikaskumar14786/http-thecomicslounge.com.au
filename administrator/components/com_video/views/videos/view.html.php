...
class VideoViewVideos extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		$canDo = VideoHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_VIDEO_TITLE_VIDEOS'), 'videos.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				JToolbarHelper::custom('videos.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
			}
		...
		{
			JToolBarHelper::preferences('com_video');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_video&view=videos');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`video_name`' => JText::_('COM_VIDEO_VIDEOS_VIDEO_NAME'),
			'a.`video_url`' => JText::_('COM_VIDEO_VIDEOS_VIDEO_URL'),
			'a.`published`' => JText::_('COM_VIDEO_VIDEOS_PUBLISHED'),
		);
	}
}
