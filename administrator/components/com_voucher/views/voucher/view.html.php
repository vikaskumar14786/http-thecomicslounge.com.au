...
class VoucherViewVoucher extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		$canDo = VoucherHelper::getActions();

		JToolBarHelper::title(JText::_('COM_VOUCHER_TITLE_VOUCHER'), 'voucher.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_voucher.voucher', $this->item->id);
		}
