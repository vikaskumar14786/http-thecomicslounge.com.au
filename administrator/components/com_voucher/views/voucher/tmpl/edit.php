...
$document->addStyleSheet(JUri::root() . 'media/com_voucher/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_voucher&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="voucher-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_VOUCHER_TITLE_VOUCHER', true)); ?>
		<div class="row-fluid">
