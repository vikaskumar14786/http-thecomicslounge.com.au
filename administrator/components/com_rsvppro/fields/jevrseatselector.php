...
class JFormFieldJevrseatselector extends JFormFieldJevrlist
{
	...
	function getInput()
	{
		...
		$html .= "<a href='".JURI::root()."administrator/components/com_rsvppro/fields/SeatSelector/seats.php?field=$id&rpid=".$row->rp_id()."&at_id=" . $rsvpdata->id.$atdee."' title='Select Seat' class='jevmodal' rel='{handler: \"iframe\", size: {x: 750, y: 470}}'>Select a seat</a>";
		return $html;
