...
<tr>
	...
	<th>
		<?php echo JHtml::_('grid.sort', 'COM_JCALPRO_ALTNAME', 'Registration.user_name', $listDirn, $listOrder); ?>
	</th>
	<th width="10%">
	...
	<th width="1%" class="nowrap hidden-phone hidden-tablet">
		<?php echo JHtml::_('grid.sort', 'COM_JCALPRO_ID', 'Registration.id', $listDirn, $listOrder); ?>
	</th>
</tr>