...
?>
<div id="registrations-permissions-form">
	<form action="index.php" method="post">
		<fieldset>
			<legend><?php echo JText::_('COM_JCALPRO_REGISTRATIONS_PERMISSIONS'); ?></legend>
			<?php
			...
			<input type="hidden" name="task" value="registrations.saverules" />
