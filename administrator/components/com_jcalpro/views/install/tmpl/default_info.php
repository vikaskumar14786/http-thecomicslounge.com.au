...
@media only screen and (min-width: 801px) {
	#jcl_install .hidden-desktop {display: none}
}
@media only screen and (max-width: 800px) {
	#jcl_install .hidden-tablet {display: none}
}
@media only screen and (max-width: 640px) {
	#jcl_install .hidden-phone {display: none}
}
</style>
<div id="jcl_install" style="text-align:left">
	<div class="row-fluid">
		<div class="span12">
		<?php
			echo JHtml::_('jcalpro.image', 'jcal_logo.png', '', array('alt' => JText::_('COM_JCALPRO_INSTALLER_TITLE'), 'class' => 'hidden-phone hidden-tablet'));
			echo JHtml::_('jcalpro.image', 'jcal_logo_small.png', '', array('alt' => JText::_('COM_JCALPRO_INSTALLER_TITLE'), 'class' => 'hidden-desktop'));
		?>
		</div>
	</div>
	<div class="row-fluid">
		...
		<div class="span4">
			<form id="jcl_install_default" method="post" action="index.php?option=com_jcalpro&task=installDefault">
				<fieldset id="jcl_install_default_fieldset">
