...
?>
<div id="locations-permissions-form">
	<form action="index.php" method="post">
		<fieldset>
			<legend><?php echo JText::_('COM_JCALPRO_LOCATIONS_PERMISSIONS'); ?></legend>
			<?php
			...
			<input type="hidden" name="task" value="locations.saverules" />
