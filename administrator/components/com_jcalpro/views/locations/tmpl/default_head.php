...
<tr>
	...
	<th class="hidden-phone">
		<?php echo JHtml::_('grid.sort', 'COM_JCALPRO_LOCATION_STATE', 'Location.state', $listDirn, $listOrder); ?>
	</th>
	<th class="hidden-phone hidden-tablet">
		<?php echo JHtml::_('grid.sort', 'COM_JCALPRO_LOCATION_POSTAL_CODE', 'Location.postal_code', $listDirn, $listOrder); ?>
	</th>
	<th class="hidden-phone hidden-tablet">
		<?php echo JHtml::_('grid.sort', 'COM_JCALPRO_LOCATION_COUNTRY', 'Location.country', $listDirn, $listOrder); ?>
	</th>
	<th class="hidden-phone hidden-tablet">
	...
	<th width="1%" class="nowrap hidden-phone hidden-tablet">
		<?php echo JHtml::_('grid.sort', 'COM_JCALPRO_ID', 'Location.id', $listDirn, $listOrder); ?>
	</th>
</tr>