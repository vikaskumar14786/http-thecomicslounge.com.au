...
<div id="jcl_component" class="<?php echo $this->viewClass; ?>">
	<?php if ($doTabs) echo JHtml::_('jcalpro.startTabSet', 'JCalProFieldsTab', array('active' => 'details')); ?>
	<?php if ($doTabs) echo JHtml::_('jcalpro.addTab', 'JCalProFieldsTab', 'details', JText::_('COM_JCALPRO_FIELDS', true)); ?>
	...
	<?php
	if ($showPerms) :
		if ($doTabs) echo JHtml::_('jcalpro.addTab', 'JCalProFieldsTab', 'permissions', JText::_('JGLOBAL_ACTION_PERMISSIONS_LABEL', true));
