...
class JFormFieldJCalAddress extends JFormFieldTextarea
{
	...
	protected function getInput() {
		...
		$input .= '<button type="button" onclick="(function(){try{jcl_map_refresh(\'' . JCalProHelperFilter::escape($this->id) . '\')}catch(err){alert(err);}})();return false;">' . JText::_('COM_JCALPRO_REFRESH_MAP') . '</button>';
		return $input;
	}
}
